...
export class ReactionController {
  ...
  @ApiOperation({
    ...
    description:
      'Add a new reaction or update an existing reaction for a message. If the user already reacted, the reaction type will be updated.',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Remove the authenticated user's reaction from a specific message.",
  })
  ...
  @ApiOperation({
    ...
    description:
      'Get all reactions made by the authenticated user with pagination.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Get statistics about reactions given and received by the authenticated user.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Get the most used reaction types in the specified time period.',
  })
  @ApiQuery({
    name: 'days',
    required: false,
