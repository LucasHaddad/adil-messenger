...
describe('ChatGateway', () => {
  ...
  describe('handleConnection', () => {
    ...
    it('should handle client connection without authentication', () => {
      ...
      expect(mockServer.emit).not.toHaveBeenCalledWith('userOnline', expect.any(Object));
    });
  });
  ...
  describe('handleJoinRoom', () => {
    ...
    it('should not join room if user not authenticated', () => {
      const unauthenticatedSocket = { ...mockSocket, userId: undefined } as unknown as Socket;
      const roomData = { roomId: 'room-1' };
  ...
  describe('handleMessage', () => {
    ...
    it('should handle message reply and notify parent author', async () => {
      ...
      expect(mockMessageService.getMessageById).toHaveBeenCalledWith('parent-1');
