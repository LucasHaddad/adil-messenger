...
describe('Integration Tests - Pipes, Filters, and Modules', () => {
  describe('ValidationPipe', () => {
    ...
    it('should reject invalid CreateUserDto', async () => {
      ...
      await expect(pipe.transform(invalidDto, metadata)).rejects.toThrow(BadRequestException);
    });
    ...
    it('should remove non-whitelisted properties', async () => {
      ...
      await expect(pipe.transform(dtoWithExtraProps, metadata)).rejects.toThrow(BadRequestException);
    });
